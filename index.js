...
class ServiceLayer {
    ...
    async createSession(config, debug = false) {
        ...
        var result = await this.instance.post('Login', {
        ...
        this.startSessionTime = new moment();
        this.endSessionTime = new moment();
    ...
    async query(q) {
        ...
        var result = await this.instance.get(q)
        return result.data;
    }
    ...
    async find(query) {
        ...
        var result = []
        var request = await this.query(query)
    ...
    async get(ressource) {
        try {
            await this.refreshSession()
            var result = await this.instance.get(ressource)
            return result.data;
        } catch (error) {
    ...
    async put(ressource, data) {
        try {
            await this.refreshSession()
            var result = await this.instance.put(ressource, data)
            return result.data;
        } catch (error) {
    ...
    async patch(ressource, data) {
        try {
            await this.refreshSession()
            var result = await this.instance.patch(ressource, data)
            return result.data;
        } catch (error) {
    ...
    async post(ressource, data) {
        try {
            await this.refreshSession()
            var result = await this.instance.post(ressource, data)
            return result.data;
        } catch (error) {
